<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SFeminino.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="principalv">
        <h2 class="tittletop">Salões Femininos</h2>
        <br />
        <div style="width: 100%; height: 10vh; margin: 0 auto;">
            <asp:TextBox runat="server" Text="" placeholder="Pesquisar" ID="pesquisaSalao" CssClass="box"></asp:TextBox>
  ...
  <asp:Label Text='<%# Bind("Rua") %>' runat="server" ID="RuaLabel" /><br />
                ...
                <asp:Label Text='<%# Bind("Celular") %>' runat="server" ID="CelularLabel" /><br />
                                <div style="text-align: center; margin-top: 14px;">
                                    <button type="button" class="btn btn-warning">Marcar</button></div>
                            </div>
                        </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' ProviderName='<%$ ConnectionStrings:ConnectionString.ProviderName %>' SelectCommand="SELECT * FROM [Tb_Cadempresa] WHERE ([Tipo] <> ?)">
        <SelectParameters>
            <asp:Parameter DefaultValue="Barbearia" Name="Tipo" Type="String"></asp:Parameter>
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
